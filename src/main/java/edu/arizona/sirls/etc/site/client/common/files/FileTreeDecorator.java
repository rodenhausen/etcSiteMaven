...
import edu.arizona.sirls.etc.site.client.common.Configuration;
...
public class FileTreeDecorator {
	...
	public Map<String, FileImageLabelTreeItem> decorate(IFileTreeView view, edu.arizona.sirls.etc.site.shared.rpc.Tree<FileInfo> fileTree, FileFilter fileFilter, 
	...
	private void decorate(IFileTreeView view, TreeItem root, edu.arizona.sirls.etc.site.shared.rpc.Tree<FileInfo> fileTree, FileFilter fileFilter, 
