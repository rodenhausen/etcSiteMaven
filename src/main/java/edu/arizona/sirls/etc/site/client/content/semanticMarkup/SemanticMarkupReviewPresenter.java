...
import edu.arizona.sirls.etc.site.client.common.ServerSetup;
	...
	public native void initIFrameMessaging() /*-{
		...
		$wnd.onmessage = function(e) {
		    if (e.data == 'done') {
		        ...
		        thisPresenterReference.@edu.arizona.sirls.etc.site.client.content.semanticMarkup.SemanticMarkupReviewPresenter::onNext()();
		    }
		}
	}-*/;
}
