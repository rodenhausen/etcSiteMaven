package edu.arizona.sirls.etc.site.shared.db;
...
public class TaskStageDAO {
	...
	private TaskStage createTaskStage(int id, String taskStage, TaskType taskType, Date created) {
		...
		case MATRIX_GENERATION:
			return new MatrixGenerationTaskStage(id, taskType, created, edu.arizona.sirls.etc.site.shared.rpc.matrixGeneration.TaskStageEnum.valueOf(taskStage));
		case SEMANTIC_MARKUP:
			return new SemanticMarkupTaskStage(id, taskType, created, edu.arizona.sirls.etc.site.shared.rpc.semanticMarkup.TaskStageEnum.valueOf(taskStage));
