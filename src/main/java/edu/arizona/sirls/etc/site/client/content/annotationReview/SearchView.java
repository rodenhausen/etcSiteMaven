...
import edu.arizona.sirls.etc.site.shared.file.search.ElementAttributeValuesSearch;
import edu.arizona.sirls.etc.site.shared.file.search.ElementValuesSearch;
import edu.arizona.sirls.etc.site.shared.file.search.ElementsSearch;
import edu.arizona.sirls.etc.site.shared.file.search.NumericalsSearch;
import edu.arizona.sirls.etc.site.shared.file.search.Search;
import edu.arizona.sirls.etc.site.shared.file.search.XPathSearch;
import edu.arizona.sirls.etc.site.shared.file.search.SearchTypeEnum;
import edu.arizona.sirls.etc.site.shared.file.search.ElementEnum;
import edu.arizona.sirls.etc.site.shared.file.search.CharacterAttributeEnum;
import edu.arizona.sirls.etc.site.shared.file.search.StructureAttributeEnum;
import edu.arizona.sirls.etc.site.shared.file.search.RelationAttributeEnum;
